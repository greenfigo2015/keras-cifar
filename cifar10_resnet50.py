...
if (K.image_data_format() == 'channels_first'):
    csv_logger = CSV_Logger('train_cifar10_resnet50_th.log', append=True)
else:
    csv_logger = CSV_Logger('train_cifar10_resnet50_tf.log', append=True)
...
if (K.image_data_format() == 'channels_first'):
    ...
    model.save('cifar10-resnet50-tf.h5')
